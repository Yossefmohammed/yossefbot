...
- Do not always end with an offer to help.

Respond naturally, like a knowledgeable consultant.
    ...
    try:
            ...
            def invoke(self, prompt):
                try:
                    ...
                    completion = self.client.chat.completions.create(
                        model=self.model,
                        messages=[
                            {"role": "system", "content": "You are Wasla AI. Follow the instructions in the user prompt strictly and do not add information outside the provided context."},
                    ...
                    # Refinement pass for clarity
                    refinement = self.client.chat.completions.create(
                        model=self.model,
                        messages=[
                            {"role": "system", "content": "Refine the following response to improve clarity, remove repetition, tighten wording, and improve flow without adding new information."},
        ...
        for model_name in working_models:
            try:
                ...
                if "Error" not in test_response and test_response:
...
def process_question(prompt, vectorstore, llm):
    try:
        ...
        formatted_prompt = WASLA_PROMPT.format(context=context, question=prompt)
...
I'm here to help you with:\n- 📋 **Information** about Wasla Solutions services and offerings\n- 🔍 **Details** from your documents and knowledge base\n- 💡 **Answers** to your specific questions\n\n**How I work:**\n- I only provide information found in your documents\n- I'll always show you my sources\n- If I don't know something, I'll be honest about it\n\nFeel free to ask me anything about the documents in my knowledge base. I'm ready to help! 🚀""",
    ...
    # Sidebar and chat input remain unchanged, just remove artificial topic injection
    # ... (copy your previous sidebar logic as-is)
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                try:
                    ...
                    response, sources = process_question(prompt, st.session_state.vectorstore, st.session_state.llm)
